...
The top-right panel SHALL display a line chart (Recharts LineChart) with 7 lines (one per level Lv1–Lv7). X-axis = simulation year, Y-axis = cultivator count. Trend data SHALL retain a maximum of 2,000 data points; older data SHALL be downsampled.
